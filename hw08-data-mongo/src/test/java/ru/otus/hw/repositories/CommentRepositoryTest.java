...
import ru.otus.hw.repositories.data.BookTestData;
import ru.otus.hw.repositories.data.CommentTestData;
...
class CommentRepositoryTest {
    ...
    static void setUp() {
        ...
        commentList = dbMapBooksComments.values().stream()
    ...
    void beforeEach() {
        ...
        InitMongoDBDataChangeLog.initData(mongoTemplate, commentList);
    }
