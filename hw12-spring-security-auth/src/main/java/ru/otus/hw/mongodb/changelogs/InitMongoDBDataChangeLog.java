...
public class InitMongoDBDataChangeLog {
    ...
    @ChangeSet(order = "004", id = "initUsers", author = "DShadrin", runAlways = true)
    public void initUsers(UserRepository repository) {
        userAdmin = repository.save(new User(null, "Admin",
                "$2a$12$37oXy.M7w/rz5tHitELgyuV20CCIbOu/I1A8ls7aPwYaZ4kQUmtx2"));
        userReader = repository.save(new User(null, "Reader",
